...
public class MainMenuScene extends BaseScene implements IOnMenuItemClickListener{
	...
	//---------------------------------------------
		...
		private void createMenuChildScene()
		{
			...
			final IMenuItem playMenuItem = new ScaleMenuItemDecorator(new SpriteMenuItem(MENU_PLAY, resourcesManager.play_region, getVbom()), 1.2f, 1);
			final IMenuItem optionsMenuItem = new ScaleMenuItemDecorator(new SpriteMenuItem(MENU_OPTIONS, resourcesManager.options_region, getVbom()), 1.2f, 1);
